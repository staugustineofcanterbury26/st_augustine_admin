...
const schema = z.object({
  ...
  contactEmail: z.union([z.literal(""), z.string().email()]).nullish().transform(val => (val && val.length > 0 ? val : null)),
  imageUrl: z.union([z.literal(""), z.string().url()]).nullish().transform(val => (val && val.length > 0 ? val : null)),
